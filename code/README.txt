...
Authors: Guillaume Tartavel, Y. Gousseau, and G. Peyre
Webpage: http://perso.enst.fr/~tartavel/
Article: http://hal.archives-ouvertes.fr/hal-00881847/
...
More details about the algorithm, the variational approach and the sparsity constraints are available in our publications (available from our webpage):
* "Variational Texture Synthesis with Sparsity and Spectrum Constraints", JMIV'13
